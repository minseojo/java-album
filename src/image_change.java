...
public class image_change extends JFrame implements ActionListener {
	...
	String[] copyList2 = new String[1000];
	String[] copyName2 = new String[1000];
	String[] copyMemo2 = new String[1000];
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == button6)  {
			make_subFrame4(); //btn3로 작동
		}
		//사진 편집
		if(e.getSource() == button7) {	
			make_subFrame5(); // button 9,10,11로 작동
		}	
		//페이지 이동
	...
	public void make_subFrame5() {
		...
		btn6 = new JButton("사진 최신/오래된순 보기");
